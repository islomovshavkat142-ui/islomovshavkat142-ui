...
**Email:** [islomovshavkat142@gmail.com](mailto:islomovshavkat142@gmail.com)
**Telegram:** @Shava_code
...
Junior Full-Stack Developer с практическим опытом разработки коммерческих веб-сайтов. Работаю с Python, Django, PostgreSQL, JavaScript, HTML и CSS.

Разрабатывал проекты самостоятельно — от структуры и пользовательского интерфейса до backend, базы данных, мультиязычности и динамического управления контентом через Django Admin.

Имею опыт взаимодействия с заказчиками, сбора требований и реализации индивидуальных решений.
...
* Реализовал backend на Django и базу данных для работы с клиентами и заказами.
* Создал пользовательскую часть сайта на HTML, CSS и JavaScript.
* Разработал Telegram-бота для передачи заказов заказчику и интегрировал его с backend.
...
* Реализовал мультиязычность на 4 языках с использованием i18n.
...
* Реализовал мультиязычность на 3 языках с использованием i18n.
